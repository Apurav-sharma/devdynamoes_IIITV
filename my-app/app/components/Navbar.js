    ...
    <div className={`flex h-10 items-center px-4 ${theme === 'vs-dark' ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'} border-b border-gray-700`}>
      <div className="flex space-x-2">
        <div className="relative">
          ...
          {showFileMenu && (
            <div 
              className={`absolute left-0 top-full w-48 shadow-lg ${
                theme === 'vs-dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'
        ...
        <button className="px-2 py-1 hover:bg-gray-700 rounded cursor-pointer">Run</button>
